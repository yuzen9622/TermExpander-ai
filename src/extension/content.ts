...
function ensureStyles() {
  ...
  style.textContent = `
.term-expander-tooltip{position:absolute;z-index:2147483647;max-width:360px;background:oklch(1 0 0);color:oklch(0.145 0 0);border:1px solid oklch(0.922 0 0);border-radius:10px;padding:10px;box-shadow:0 6px 18px rgba(0,0,0,.12);font-family:system-ui,-apple-system,Segoe UI,Roboto,Noto Sans,Arial,sans-serif}
.term-expander-tooltip .row{display:flex;gap:8px;align-items:center;justify-content:space-between}
.term-expander-tooltip .message{font-size:12px;color:oklch(0.556 0 0)}
...
.term-expander-tooltip .snippet{margin-top:8px;font-size:12px;color:oklch(0.556 0 0);max-height:84px;overflow:auto;white-space:pre-wrap}
.term-expander-tooltip .result{margin-top:8px;font-size:12px;color:oklch(0.145 0 0);white-space:pre-wrap}
`;
